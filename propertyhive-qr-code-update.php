...
class properthive_qr_code_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'https://wp-property-hive.com/add-on-store/propertyhive-qr-code-t35vju22/update-info.php',
...
if( is_admin() )
{
	new properthive_qr_code_update();
}
